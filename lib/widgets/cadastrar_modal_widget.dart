    ...
    return BlocBuilder<CadastrarCubit, CadastrarState>(
      builder: (context, state) {
        Future<void> _pickFile(BuildContext context, String type) async {
          ...
          if (result != null) {
            final File files = File(result.files.single.path!);
            ...
            if (expirationDate != null) {
              ...
              context.read<CadastrarCubit>().addDocument(
                  file,
                  expirationDate,
                  type,
                  files); // Trigger addDocument with the selected file and date
            }
          }
        }
                          ...
                          Row(
                            children: [
                              ...
                              Text(
                                '*',
                                style: DockTheme.h2.copyWith(
                                    color: DockColors.danger100, fontSize: 18),
                              ),
                            ],
                          ),
                          Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                if (state.documents
                                    .any((document) => document.type == "ASO"))
                                  Padding(
